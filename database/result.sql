...
('Anant Singh', 126, 'SEM-6', 'SPCC', 'Software Engineering', 'CSS', 'IP', 'DM', 60, 80, 85, 90, 92, 407, 81.4),
('Devesh Rai', 103, 'SEM-6', 'SPCC', 'Software Engineering', 'CSS', 'IP', 'DM', 80, 90, 95, 90, 85, 440, 88);
('Arya Tiwari', 104, 'SEM-6', 'SPCC', 'Software Engineering', 'CSS', 'IP', 'DM', 85, 92, 96, 97, 88, 440, 88);
('Krishna Jaiswal', 105, 'SEM-6', 'SPCC', 'Software Engineering', 'CSS', 'IP', 'DM', 80, 90, 95, 90, 85, 448, 90);
('Divyanshu Singh', 106, 'SEM-6', 'SPCC', 'Software Engineering', 'CSS', 'IP', 'DM', 80, 90, 95, 90, 85, 441, 91);
-- --------------------------------------------------------
...
('CE103', 'Devesh Rai', 'ar@gmail.com', 'Male', 103, 'B.Tech', 'SEM-6'),
('CE134', 'Sanika Shete', 'vk@gmail.com', 'Female', 134, 'B.Tech', 'SEM-6'),
('CE126', 'Anant Singh', 'yk@gmail.com', 'Male', 126, 'B.Tech', 'SEM-6');
